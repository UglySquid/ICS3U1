...
class Ball(pygame.sprite.Sprite):
    ...
    def __init__(self, screen):
        """This initializer takes a screen surface as a parameter, initializes  the image and rect attributes, and x,
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, player_num):
        """This initializer takes a screen surface and player number as parameters.
        Depending on the player number,
        it loads the appropriate image and positions it on the left or right end of the court"""
        # Call the parent __init__() method
        pygame.sprite.Sprite.__init__(self)
        ...
        # position it 10 pixels from the screen left.
        if player_num == 1:
            self.rect.left = 10
    ...
    def change_direction(self, xy_change):
        """This method takes an (x,y) tuple as a parameter, extracts the
...
class ScoreKeeper(pygame.sprite.Sprite):
    ...
    def winner(self):
        ...
        This method returns 0 if there is no winner yet, 1 if player 1 has won, or 2 if player 2 has won."""
