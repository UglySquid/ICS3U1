...
def main():
    ...
    # if the user enters a no-value input, it'll ask the user again
    ...
    while not winner_board(ttt_board1, ttt_board2, ttt_board3) and free_cells > 0:
        ...
        # each time this while loop runs, a free cell will be subtracted from 26
        if winner_board(ttt_board1, ttt_board2, ttt_board3) == "X":
            ...
            hall_names_list = hall_names.split("\n")

            while win_name in hall_names_list:
...
def user_move(ttt_board1, ttt_board2, ttt_board3):
    ...
    while not valid_move:
        ...
        # from the users answer it'll run through each if statement and proceed to ask what column and row to play
        ...
        if layer_num == 1:
            ...
            if (0 <= row <= 2) and (0 <= column <= 2) and (ttt_board1[row][column] == " "):
...
def computer_move(ttt_board1, ttt_board2, ttt_board3):
    ...
    for row in range(3):
        for column in range(3):
            if ttt_board1[row][column] == " ":
                blank_1.append((row, column))
            if ttt_board2[row][column] == " ":
                blank_2.append((row, column))
            if ttt_board3[row][column] == " ":
                blank_3.append((row, column))

    for row, column in blank_1:
        ttt_board1[row][column] = "O"
        if winner_board(ttt_board1, ttt_board2, ttt_board3) == "O":
            ttt_board1[row][column] = "O"
            return
        else:
            ttt_board1[row][column] = " "

    for row, column in blank_1:
        ttt_board1[row][column] = "X"
        if winner_board(ttt_board1, ttt_board2, ttt_board3) == "X":
            ttt_board1[row][column] = "O"
            return
        else:
    ...
    for row, column in blank_2:
        ttt_board2[row][column] = "O"
        if winner_board(ttt_board1, ttt_board2, ttt_board3) == "X":
            ttt_board2[row][column] = "O"
            return
        else:
            ttt_board2[row][column] = " "

    for row, column in blank_2:
        ttt_board2[row][column] = "X"
        if winner_board(ttt_board1, ttt_board2, ttt_board3) == "X":
            ttt_board2[row][column] = "O"
            return
        else:
    ...
    for row, column in blank_3:
        ttt_board3[row][column] = "O"
        if winner_board(ttt_board1, ttt_board2, ttt_board3) == "O":
            ttt_board3[row][column] = "O"
            return
        else:
            ttt_board3[row][column] = " "

    for row, column in blank_3:
        ttt_board3[row][column] = "X"
        if winner_board(ttt_board1, ttt_board2, ttt_board3) == "X":
            ttt_board3[row][column] = "O"
            return
        else:
